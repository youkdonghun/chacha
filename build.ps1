...
$taskArchive = Join-Path $taskOutput 'ChachaCapture-1.0.0-win-x64.zip'
Compress-Archive -LiteralPath @($taskExe, (Join-Path $taskOutput 'README.md'), (Join-Path $taskOutput 'LICENSE'), (Join-Path $taskOutput 'SHA256SUMS.txt')) -DestinationPath $taskArchive -Force
