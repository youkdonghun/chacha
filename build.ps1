...
Copy-Item -LiteralPath @((Join-Path $taskRoot 'docs\PARITY.md'), (Join-Path $taskRoot 'docs\VALIDATION.md'), (Join-Path $taskRoot 'docs\RELEASE-v1.4.1.md')) -Destination $taskDocs -Force
...
$taskArchive = Join-Path $taskOutput 'ChachaCapture-1.4.1-win-x64.zip'
