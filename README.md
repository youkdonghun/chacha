...
| 복사하고 캡처 종료 | **Enter**, **Ctrl+C**, 영역 더블클릭 |
| 화면에 고정 | **Ctrl+T**, 영역 가운데 클릭 |
...
- 네트워크 요청, 계정 로그인, 원격 업로드 기능은 없습니다.
...
v1.1.0은 캡처·주석·붙여넣기의 조작을 크게 확장한 버전입니다. **Snipaste 전체 제품과 완전한 1:1 일치를 보증하는 버전은 아닙니다.**
...
결과: `dist\ChachaCapture.exe`, `dist\ChachaCapture-1.1.0-win-x64.zip`, SHA-256, 자체 검사 결과.
[검증 기록](docs/VALIDATION.md)과 [변경점](docs/RELEASE-v1.1.0.md)을 참고하세요.
