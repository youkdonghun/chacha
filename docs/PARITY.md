...
| 단축키 설정 | 클릭 후 실제 키 조합 즉시 인식·안내, 설정 저장으로 적용, 기능별 해제·미지정 | Windows 키 조합은 미지원; 다른 앱의 전역 등록 충돌은 저장 전에 확인 |
...
| UI | 둥근 버튼·카드·입력란, 한국어 대시보드·그룹·탭 설정·도구 모음 | 원본 테마·레이아웃·아이콘과 동일하지 않음 |
