...
$taskReport = Join-Path $taskRoot 'artifacts\desktop-integration-v1.4.txt'
if ($WorkflowOnly) { $taskReport = Join-Path $taskRoot 'artifacts\workflow-integration-v1.4.txt' }
